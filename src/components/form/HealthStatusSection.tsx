...
const HealthStatusSection: React.FC<HealthStatusSectionProps> = ({
  ...
  // Only render if health calculation type is manual
  if (formData.health_calculation_type !== "manual") {
    return null;
  }
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-1">
            ...
            <Tooltip>
              ...
              <TooltipContent>
                <p className="max-w-xs">
                  Enter a percentage (0-100) to manually set the project health.
                  This is only used when Health Calculation is set to Manual.
                </p>
              </TooltipContent>
            </Tooltip>
          </div>
