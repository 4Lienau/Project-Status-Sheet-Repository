...
const ProjectDetailsSection: React.FC<ProjectDetailsSectionProps> = ({
  ...
  // Calculate the current health status using the standardized function
  const currentHealthStatusColor = calculateProjectHealthStatusColor(formData);
  const completionPercentage =
    formData.health_calculation_type === "manual"
      ? formData.manual_health_percentage || 0
          ...
          <div className="flex items-center gap-4">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <div
                  className={`w-16 h-16 flex items-center justify-center text-white text-2xl font-bold rounded-full shadow-md border border-gray-700 cursor-help ${
                    currentHealthStatusColor === "green"
                      ? "bg-green-500"
                      : currentHealthStatusColor === "yellow"
                        ? "bg-yellow-500"
                        : "bg-red-500"
                  }`}
                >
              ...
              <TooltipContent>
                <p className="max-w-xs">
                  Health Status: {currentHealthStatusColor.toUpperCase()}
                  <br />
                  Completion: {completionPercentage}%<br />
                  {formData.health_calculation_type === "manual"
                    ? "Using manual health calculation"
                    : "Using automatic calculation based on milestones and time remaining"}
                </p>
              </TooltipContent>
            </Tooltip>
          </div>
              ...
              <Tooltip>
                ...
                <TooltipContent>
                  <p className="max-w-xs">
                    ...
                    including its purpose, goals, and scope. You can use the AI
                    button to automatically generate a description based on your
                    project title.
                  </p>
                </TooltipContent>
              </Tooltip>
              ...
              <Tooltip>
                ...
                <TooltipContent>
                  <p className="max-w-xs">
                    ...
                    automatically generate a value statement based on your
