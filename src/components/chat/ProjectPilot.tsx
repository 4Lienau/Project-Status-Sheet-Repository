...
const ProjectPilot: React.FC<ProjectPilotProps> = ({
  ...
  if (!isOpen) {
    return (
      <Button
        onClick={toggleChat}
        className="fixed bottom-6 left-6 z-50 rounded-full w-14 h-14 p-0 bg-blue-600 hover:bg-blue-700 shadow-lg hover:shadow-xl transition-all duration-300"
      >
  ...
  return (
    <Card
      className={cn(
        "fixed left-6 bottom-6 z-50 shadow-xl transition-all duration-300",
